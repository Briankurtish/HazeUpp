...
import 'package:hazeupp/common/widgets/loadrers/category_shimmer.dart';
import 'package:hazeupp/features/shop/controllers/category_controller.dart';
import 'package:hazeupp/features/shop/screens/sub_category/sub_categories.dart';
...
class THomeCategories extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (categoryController.isLoading.value) return const TCategoryShimer();
